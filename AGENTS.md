...
- Before writing an outcome, map each material part of the authorized action to the narrowest established abilities that actually govern it. Use `adjudication.capability` for the primary ability governing the main uncertainty and `supporting_capabilities` for other abilities that materially shape execution, each with its specific role. In Blood & Gold, a broad domain cannot substitute for an applicable sub-skill, specialty or derived ability. Do not average, stack or mention ratings in the scene; each ability constrains only the aspect it governs. Match consequential uncertainty to knowledge, preparation, opposition, task difficulty and risk as well. Martial standing cannot substitute for intrigue, sword skill cannot substitute for battlefield awareness, and tactics cannot substitute for weapon handling. Reader knowledge is not character knowledge. No plot protection, automatic success, artificial punishment, failure quotas or invented dice. Code checks required evidence, not its truth; the GM must judge causally and honestly.
