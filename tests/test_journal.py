...
class JournalTests(unittest.TestCase):
    ...
    def test_story_preserves_exact_prose_actual_turns_and_fictional_interval(self):
        ...
        self.assertIn("Elapsed: 2 hours", story)
        self.assertIn("Day 0, 12:00 to Day 0, 14:00", changes)
        self.assertIn("Day 0, 14:00 to Day 3, 14:00", changes)
        self.assertIn("Elapsed since opening: 3 days, 2 hours", changes)
    ...
    def test_journey_progress_and_cumulative_time_are_recorded_without_inventing_distance(self):
        ...
        self.assertIn("Elapsed this turn: 5 hours", first)
        self.assertIn("Elapsed since opening: 5 hours", first)
        self.assertIn("Location: Invented test ford", first)
        self.assertIn("Distance this turn: 9 miles", first)
        self.assertIn("Distance so far: 9 miles", first)
        self.assertIn("Elapsed since opening: 7 hours", second)
    ...
    def test_missing_journey_data_remains_unknown_and_capability_reasoning_stays_separate(self):
        ...
        self.assertIn("Primary ability: accounts", changes)
        self.assertIn("Supporting ability: sword", changes)
        self.assertNotIn("character.skills", changes)
    ...
    def test_recorded_opening_is_rendered_verbatim_without_creating_a_first_turn(self):
        ...
        self.assertIn("[Turn 0: opening](turns/turn-000000.md): Day 0, 00:00; Invented test store yard", self.read("README.md"))
