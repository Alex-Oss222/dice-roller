...
| Field | Character |
| --- | --- |
| Campaign title | **A Song of Blood & Gold: The Trident** |
...
In **Adjudicated** mode, consequential uncertainty is resolved from established circumstances, capabilities, preparation, opposition, resources, position, injury, terrain, and causality. Capability Ratings are evidence used in that judgment, not die-roll bonuses. Ned's canonical importance provides no immunity from wounds, capture, failure, or death.

## Opening Position

The rebel and royal hosts are close enough that a major engagement is expected the next day. Prince Rhaegar Targaryen commands the royal army. The rebel coalition is led by Robert Baratheon, Jon Arryn, Hoster Tully, and Eddard Stark.

Ned is inside his command tent. The evening meal is over. His sword lies across his knees while he works the edge with a whetstone. His battle armor and other battle equipment are nearby but are not being worn. Elsewhere in camp, men are checking armor, feeding and watering horses, repairing weapons, assigning sentries, and passing orders through captains.

No battlefield action has begun. No final pre-battle decision has been made for Ned. The next action remains the player's choice. This preparation does not resolve any part of it.
...
**Common name:** Ned  
**Age:** Approximately 20; born 263 AC  
**Sex:** Male  
...
**Social status:** Great lord; head of House Stark; rebel army commander  
...
**Family:** Son of Lord Rickard Stark and Lady Lyarra Stark. Younger brother of Brandon Stark; elder brother of Lyanna and Benjen Stark. Rickard and Brandon are dead by order of King Aerys II. Lyanna is missing. Benjen is alive, but his exact activity at this starting moment is not needed for the opening scene.  
...
**Typical clothing:** Northern noble clothing and campaign dress. At the opening moment he is not wearing his battle armor. Exact garments are not fixed unless they matter.  
**Heraldry or personal device:** House Stark, a grey direwolf on an ice-white field; words: *Winter Is Coming*.

Appearance is descriptive unless a circumstance makes it relevant. It provides no automatic bonus.

---

## Natural Attributes and Aptitude

Natural attributes are separate from learned Capabilities. The assessments below are qualitative judgments from established history rather than numerical bonuses.

| Attribute | Assessment | Basis |
| --- | --- | --- |
...
No exceptional aptitude is established at campaign start. Unless later evidence justifies a distinction, treat Ned's aptitude as **Ordinary** for advancement purposes. His competence comes primarily from upbringing, training, responsibility, and experience rather than a free aptitude bonus.
...
All learned Capabilities use the **0 to 9 Rating scale** from the supplied character-sheet framework.
...
For play bookkeeping, established trainable Capabilities begin at **0 Development toward their next Rating** unless a later campaign decision explicitly assigns partial pre-campaign progress. This is a bookkeeping baseline, not a claim that Ned learned nothing immediately before Turn 0.
...
| --- | ---: | ---: | --- |
| Persuasion | 3 | 0 / 12 | Trained noble dealing; more credible and direct than flamboyantly persuasive |
| Hospitality | 3 | 0 / 12 | Great-house upbringing |
| Mediation | 3 | 0 / 12 | Plausible noble experience, but little direct evidence before the Trident |
| Court Etiquette | 3 | 0 / 12 | Eyrie upbringing and high-noble society |
...
| Dagger | 3 | 0 / 12 | Canonically uses a dagger; secondary rather than defining weapon |
| Wrestling / Unarmed | 3 | 0 / 12 | Noble martial education; no specialist reputation |
| Archery | 2 | 0 / 10 | Reasonable exposure for a northern noble, but no evidence of emphasis |
...
| Sub-skill | Rating | Development | Weight | Basis |
| --- | ---: | ---: | ---: | --- |
| Detecting Lies | 2 | 0 / 10 | 30% | Basic noble judgment; no pre-Trident evidence of expert deception detection |
| Concealment | 4 | 0 / 14 | 25% | Some practical discretion and wartime caution |
| Information Networks | 3 | 0 / 12 | 20% | Access to household and military reports, but no spy-master reputation |
| Counterintelligence | 2 | 0 / 10 | 15% | Commander-level awareness without specialist evidence |
| Deception | 1 | 0 / 8 | 10% | Reserved and capable of keeping counsel, but directness is much better established than manipulative lying |
| **Total** |  |  | **100%** | **2.60 → Intrigue 3** |

### Established Sub-skills

| Sub-skill | Rating | Development | Basis |
| --- | ---: | ---: | --- |
| Eavesdropping | 1 | 0 / 8 | No special practice established |
| Rumor | 2 | 0 / 10 | Knows how information moves through noble and military circles |
| Secret Correspondence | 2 | 0 / 10 | Plausible noble wartime competence, not specialist cryptography |

### Derived Sub-skills

| Sub-skill | Rating | Basis |
| --- | ---: | --- |
| Surveillance | **2D** | Intrigue 3 plus military awareness, without dedicated covert training |
| Espionage Management | **1D** | Some access to scouts and reports, but no basis for a true spy network |
...
Ned has no established professional craft. The Domain exists only to represent routine personal maintenance expected of a trained noble campaigning in the field.

### Anchor Skills

| Sub-skill | Rating | Development | Weight | Basis |
| --- | ---: | ---: | ---: | --- |
| Weapon Care | 4 | 0 / 14 | 40% | Opening scene explicitly establishes that Ned can maintain and sharpen his own sword |
| Leather / Strap Maintenance | 2 | 0 / 10 | 30% | Basic campaign familiarity only |
| Camp Gear Maintenance | 2 | 0 / 10 | 30% | Basic field competence only |
| **Total** |  |  | **100%** | **2.80 → Craft 3** |

### Derived Sub-skills

| Sub-skill | Rating | Basis |
| --- | ---: | --- |
| Armor Repair | **2D** | Craft 3 and routine campaign maintenance support minor field repairs, but Ned is not an armorer |
| Field-Expedient Gear Repair | **2D** | Routine maintenance experience supports simple temporary repairs; professional manufacture remains outside his competence |
...
Combat competence is recorded through Martial Sub-skills, with Fieldcraft contributing to riding and terrain. These entries summarize rather than duplicate those Ratings.
...
**Readiness:** Sword maintenance underway; armor and battle gear nearby; no battlefield engagement has begun.

Combat adjudication considers training, weapon reach, armor coverage, surprise, terrain, fatigue, numbers actually engaged, command position, preparation, and escape routes. There is no abstract hit-point buffer and no protagonist protection.

---

# Condition

**Proposed starting Condition: 8, Hale.**

| Field | Seed assessment |
| --- | --- |
| Rating | **8** |
...
Tags explain causes and can be precise, such as Arrow Wound or Blood Loss. They do not each deduct a point. Assess combined severity and concrete limitations; record wounds and treatment below. There is no fixed dice penalty, automatic healing schedule, or abstract hit-point buffer. Condition changes do not erase learned ability.

## Wounds

| Injury | Severity | Concrete effect | Treatment | Review date |
| --- | --- | --- | --- | --- |
| None established |  |  |  |  |

Defined wound severities: **Minor → Serious → Critical → Fatal**. These are classifications, not mandatory stages.

## Other Conditions

**Illness:** None established  
**Exhaustion:** None established  
**Hunger/thirst:** Evening meal already taken; otherwise normal unless circumstances establish a problem  
**Intoxication:** None established  
**Long-term disability:** None established  
**Other:** None
...
**Coin on hand:** Not established. A great lord's access to resources does not imply a known purse balance in the tent.

| Currency | Amount |
| --- | ---: |
| Gold dragons | Not established |
| Silver stags | Not established |
| Copper pennies | Not established |
| Copper stars | Not established |

No conversion assumption is required until money matters in play.
...
**Food:** Rebel camp provisions exist; Ned's exact personal reserve is not separately tracked  
**Water:** Available through camp supply unless circumstances change  
**Travel provisions:** Campaign-level supplies, exact quantity unknown  
**Medical supplies:** Available through the host only to the extent established in play; exact stores unknown  
**Arrows/bolts:** Not personally tracked for Ned  
**Other consumables:** Whetstone present; other consumables not individually established

## Income and Obligations

| Item | Amount/rate | Frequency | Next due |
| --- | ---: | --- | --- |
| House Stark income | Not quantified | Ongoing | Not relevant to opening night |
| Household cost | Not quantified | Ongoing | Not relevant to opening night |
| Army support obligations | Not quantified | Active campaign | Immediate and ongoing |
| Debt | None established |  |  |

Treat uncertain prices, rates, distances, and conversions as campaign assumptions rather than canonical facts.
...
**General reputation at Turn 0:** A young, reserved, dutiful great lord who has successfully raised and marched the North and has already proven useful in battle. Robert explicitly credits Ned with saving him at the Battle of the Bells. Ned is trusted by Robert and Jon Arryn, but the campaign does not import every later-life reputation as if it were already universal in 283 AC.

Reputation is tracked through actual evidence known to particular people or groups, not a universal score.

---

# Relationships

| Person / faction | Relationship | Known attitude | Evidence | Obligations |
| --- | --- | --- | --- | --- |
| Robert Baratheon | Foster brother, close friend, principal rebel ally | Strong mutual trust and affection; Robert values Ned's loyalty and military support | Raised together at the Eyrie; active rebellion; Battle of the Bells | Support the rebel cause while retaining Ned's own judgment and command |
| Jon Arryn | Foster father, mentor, senior rebel ally | Deep trust and filial respect | Fostered Ned from age eight; refused Aerys's demand for Ned's head | Coalition loyalty, counsel, and mutual military support |
| Catelyn Tully | Newly married wife | Relationship is new and politically arranged; mutual personal understanding is still limited | Married after the Battle of the Bells | Marital and dynastic obligations; Tully alliance |
| Hoster Tully | Father-in-law and rebel ally | Political alliance and mutual military interest | Tully support tied to the marriages at Riverrun | Coalition coordination and family alliance |
| Lyanna Stark | Younger sister, missing | Strong family concern; exact circumstances unresolved | Her disappearance helped trigger the crisis leading to war | Personal desire to recover her or learn her fate |
| Benjen Stark | Younger brother | Familial bond; exact current duties not specified | Shared Stark upbringing | House continuity and kinship |
| Northern bannermen | Feudal vassals and fighting men under Ned's command | Serving under their lawful lord in rebellion; individual attitudes vary | Ned called the banners and led the northern army south | Ned owes competent leadership and must weigh their lives against military necessity |
| Howland Reed | Bannerman and personal friend | Friendly and trusted based on Harrenhal connection | Met at the tourney at Harrenhal | Ordinary lord-vassal obligations plus personal friendship; present location not assumed |

NPC attitudes are not fixed morality meters. They may disagree, refuse, bargain, fear, respect, distrust, or change position when their reasons change.
...
| Report | Source | Arrival time | Reliability / status |
| --- | --- | --- | --- |
| Royal army strength and exact deployment | Scouts, captains, allied commanders | Pre-battle | **Not fixed in Ned's sheet.** He may seek or receive better intelligence in play. |
| Lyanna was taken by Prince Rhaegar | Widely accepted cause of the crisis | Before rebellion | Ned knows the public account, but her exact current location, condition, and full circumstances are unresolved to him |
| Loyalist intentions for the coming engagement | Military observation and reports | Ongoing | Only what is causally established in play becomes reliable PC knowledge |

## Secrets Known by the PC

No campaign-relevant secret is preloaded beyond facts Ned has a causal reason to know. Later canon revelations are not imported into his Turn 0 knowledge.

## Unknowns

- Exact calendar date within 283 AC.
- Exact royal battle plan.
- Exact reliable enemy numbers and order of battle unless established through in-world intelligence.
- The outcome of the coming battle.
- Ned's own survival, wounds, capture status, or future route.
- Lyanna's precise whereabouts and condition.
- Any later canon event after this starting moment.

Anything Ned has no causal way to know remains unknown to the player character.
...
No additional specific promise is established at Turn 0.

## Debts

No quantified personal debt is established. Political obligations arising from alliance and marriage are handled as relationships and duties, not coin debt.

## Standing Orders

No personal standing order is pre-authored beyond the ordinary camp preparations already described in the starting premise. The player may issue, revise, or cancel plausible orders before battle.

## Active Tasks

| ID | Actor/objective | Prerequisites/resources | Due date or progress/trigger | Completion consequence | Status | Expected news |
| --- | --- | --- | --- | --- | --- | --- |
| None | **No mandatory pre-battle task has been chosen for Ned.** |  |  | The player retains control over the next action |  |  |
...
**Household:** House Stark campaign household present in some form; details to be established when relevant

Numbers and loyalty are adjudicated from status, location, obligations, resources, and established relationships rather than assigned automatically for convenience.

---

# Character-Specific Adjudication

When resolving an uncertain action:

1. Use the most relevant established Sub-skill or Specialty.
2. Use the Domain Rating only for genuinely broad tasks or where no narrower established ability applies.
3. Use a Derived Rating only when the background genuinely supports the inference.
4. Separately consider attributes, equipment, overall Condition, its tags and concrete effects, wounds, fatigue, numbers, position, information, preparation, opposition, and terrain. Do not count the same impairment twice.
5. Aptitude affects development, not instant performance.
6. Do not count the same advantage twice.
7. Ned's narrative importance never overrides causality.

Routine feasible actions succeed directly. Impossible actions need no check. Consequential uncertainty is resolved from the established circumstances, with the decisive cause stated briefly.
...
- Northern army is already in camp and preparing for expected battle.
...
- A great lord's status does not make supplies, horses, guards, or information appear without causal availability.

### Relevant training

- Longsword, two-handed sword, and ordinary noble weapons
- Shield and armored fighting
- Mounted combat and riding
- Frontline and formation leadership
- Tactics and campaign logistics
- Noble law, heraldry, literacy, and protocol
- General fieldcraft and camp life

### Untrained or weakly trained areas

- Sophisticated espionage and manipulation
- Professional medicine or surgery
- Professional crafts such as armorsmithing or weaponsmithing
- Specialized siege engineering
- Naval warfare
- High-level scholarly fields and foreign languages not otherwise established
- Elite archery

### Social leverage

- Authority over House Stark's bannermen and northern troops.
- Foster-brother bond with Robert.
- Foster-son relationship with Jon Arryn.
- Marriage tie to Hoster Tully through Catelyn.
- Personal credibility from bringing the northern host south and helping at the Battle of the Bells.

### Political vulnerabilities

- Open rebel against the reigning king.
- Rickard and Brandon are dead, leaving House Stark's adult leadership thinned.
- Lyanna remains missing.
- The Tully alliance is new and partly secured through marriage politics.
- Failure or death at the Trident could place northern command and Stark succession under severe strain.
...
## Book-background claims supplied for setup

These are the source sheet's background claims. The [source check](notes/source-check.md) distinguishes consulted author remarks, secondary book references, and unverified details; it is not a claim that every underlying book passage was independently read. The birth year is supported here by a secondary chronology calculation, and the discussion of Ice's usual role also draws on reported author remarks.

- Eddard Stark was born in 263 AC at Winterfell and is approximately twenty in 283 AC.
- He is the son of Rickard and Lyarra Stark, younger brother of Brandon, and elder brother of Lyanna and Benjen.
- He was fostered by Jon Arryn at the Eyrie from age eight and became close to Robert Baratheon.
- He attended the tourney at Harrenhal in 281 AC.
- Rickard and Brandon were killed by order of Aerys II; Aerys then demanded Ned's and Robert's heads.
- Ned succeeded as Lord of Winterfell, returned north, called his banners, and marched south.
- Ned and Hoster Tully's forces reached Stoney Sept and helped turn the Battle of the Bells.
- Ned married Catelyn Tully at Riverrun after the Battle of the Bells.
- House Stark follows the old gods; its arms are a grey direwolf on an ice-white field.
- Ned is canonically associated with sword and dagger use; Ice is the ancestral Valyrian steel greatsword of House Stark and is chiefly used by Ned ceremonially and for executions.

## Campaign premises supplied by the player

- Start is the **evening before the Battle of the Trident** in 283 AC.
- The exact calendar date is deliberately left unknown because the books do not establish it.
- The rebel encampment is beside the Trident in the Riverlands.
- Ned is in his command tent in the northern section of camp after the evening meal.
- He is sharpening his sword with a whetstone.
- His armor and battle equipment are nearby but not worn.
- The host is engaged in ordinary final preparations for battle.
- Prince Rhaegar commands the royal army nearby.
- No battlefield action has begun.
- No pre-battle decision has been chosen for Ned.
- Resolution is **Adjudicated**, with no dice and no plot armor.
...
- The Battle of the Trident is expected the next day, but the exact date and hour are not invented.
- Ned begins unwounded and without specifically established exhaustion because the starting premise establishes no injury or debilitating condition.
- Exact enemy strength, detailed deployment, and plans are not automatically treated as Ned's confirmed knowledge.
- Equipment not explicitly present is not granted merely because a lord could plausibly own it.
- Ratings represent what Ned can actually do at approximately twenty, not what his later reputation might suggest.
